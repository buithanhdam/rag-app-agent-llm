...
from src.agents.assistant_step import AssistantAgentWorker

DEFAULT_MAX_FUNCTION_CALLS = 5


class AssistantAgent(AgentRunner):
    """OpenAI agent.
    ...
    def __init__(
        ...
        step_engine = AssistantAgentWorker.from_tools(
            tools=tools,
    ...
    def from_tools(
        ...
        **kwargs: Any,
        ...
        #     total_messages = [ChatMessage(content=system_prompt, role="system")]
        #     if prefix_messages is not None:
        #         total_messages= total_messages + prefix_messages
