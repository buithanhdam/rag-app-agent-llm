...
class FusionRAG(BaseRAGManager):
    ...
    def process_document(
        ...
        try:
            ...
            raise
    def fuse_rerank(self,nodes_with_scores: List[NodeWithScore], similarity_top_k: int = 2):
        """Fuse results."""
    ...
    def search(
        ...
        try:
            ...
            for sub_query in queries:
                sub_query_embedding = self.embedding_model.get_text_embedding(sub_query)
                ...
                if doc_nodes:
                    ...
                    bm25_results = bm25_retriever.retrieve(sub_query)
